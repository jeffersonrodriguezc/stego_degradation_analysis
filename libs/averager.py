...
from libs import locator
from libs import aligner
from libs import warper
from libs import blender

def list_imgpaths(imgfolder: str) -> Generator[str]:
    """ List all image paths in a folder
    :param imgfolder: folder path
    :type imgfolder: str
    :returns: generator of image paths
    :rtype: Generator
    """

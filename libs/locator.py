...
dlib_detector = dlib.get_frontal_face_detector()  # type: ignore
dlib_predictor = dlib.shape_predictor(path.join(DATA_DIR, 'shape_predictor_68_face_landmarks.dat'))  # type: ignore
...
def weighted_average_points(start_points, end_points, percent=0.5) -> np.ndarray:
